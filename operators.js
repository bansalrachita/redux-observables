action$.do( (action)=> console.log(action) ); -> do will perform an action with generating more elements
action$.do( (action)=> console.log(action) ).ignoreElements(); - stops searching for action output stream and prevents going into infinite loop.
...
action$
	.ofType(“ANC")
	.switchMap(() => {
		return Observable.of(“ABC”).delay(1000);
	})
